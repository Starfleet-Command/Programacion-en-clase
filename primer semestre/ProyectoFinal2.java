...
public class ProyectoFinal2
{
  public static void main(String[] args) throws IOException
  {
    ...
    String[][] arreglo3 = new String[100][];
...
u++;
      ...
      if(eliminando.equals( "si"))
      {
        ...
        elim = lector.nextInt();
        arreglo3 = Eliminado(arreglo2,elim);
      }

      if (poner.equals("si"))
      {
        System.out.println("Que usuario desea añadir?");
        pon = lector.nextInt();
        Agregar(arreglo2);
      }
...
while(arreglo2[cont] != null)
{
 ...
 //------------------------Metodos---------------------------------------------/
   ...
   {
     String[][] arreglo4 = new String[arreglo3.length][arreglo3[0].length];

   for (int l=0; l<arreglo3.length; l++) {
     for(int k=0;k<arreglo3[0].length; k++)
     {
     arreglo4[l][k] = arreglo3[l][k];
     if (Integer.toString(quita).equals(arreglo3[l]))
     {
       arreglo4[l][k] = "";
     }
   }
   ...
   public static void Agregar(String[][] arreglo3 )
   {
     int poner = 0;
     for (int z=0; z<arreglo3.length; z++)
     {
       if (arreglo3[z][0] == "xxxxxxx")
       {
          poner= z  ;
       }
     }
     ...
     for (int x=1; x<arreglo3[0].length;x++)
     {
         // System.out.println("Vamos a agregar "+ arreglo3[0][x] );
         arreglo3[poner][x]= e.nextLine();  //Esto tiene que estar en el mismo formato que el documento original
   }
